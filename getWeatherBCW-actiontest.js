...
function main(params) {
  return new Promise(function(resolve, reject) {
    ...
    //if (params.conversation.context.city.name == 'San Francisco'){
      ...
      var city = "San Francisco"; //params.conversation.context.city;
      var state = "California"; //params.conversation.context.state;

      var latitude = 37.655 //city.states[state].latitude;
      var longitude = -122.408//city.states[state].longitude;
      const range = '7day';
      ...
      request({
        ...
        if (error || response.statusCode != 200) {
          ...
          output.conversation.context.weather_conditions="hartmut wetter conditions"
          resolve(output);
        }
      });
    } else {
